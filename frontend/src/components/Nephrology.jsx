                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR NEPHROLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href='ApekshaPatilNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>PRINCIPAL DIRECTOR NEPHROLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href='ManmathShelkeNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl cover h-96">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>SENIOR DIRECTOR & HOD NEPHROLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href='TirupattiShelkeNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 bg-cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>SENIOR DIRECTOR & HOD NEPHROLOGY & RENAL TRANSPLANT</p>
                                    <div className="card-actions justify-between">
                                    <a href='RajeshSwamiNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR NEPHROLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href='AnupKulkarniNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR NEPHROLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href='ArjunShelkeNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR NEPHROLOGY & UNIT HEAD- NEPHROLOGY & KIDNEY TRANSPLANT</p>
                                    <div className="card-actions justify-between">
                                    <a href='SharadSonawaneNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR NEPHROLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href='SonalBaroleNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR NEPHROLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href='TusharGangawaneNephrology'><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card bg-base-100 image-full w-96 shadow-xl h-72">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-start mt-40">
                                    <button className="btn opacity-55">Blood urea nitrogen (BUN) test</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card bg-base-100 image-full w-96 shadow-xl">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-start mt-40">
                                    <button className="btn opacity-55">Creatinine test</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card bg-base-100 image-full w-96 shadow-xl">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions  justify-start mt-40">
                                    <button className="btn opacity-55">Hemodialysis</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card bg-base-100 image-full w-96 shadow-xl">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-start mt-40">
                                    <button className="btn opacity-55">Intravenous pyelogram</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card bg-base-100 image-full w-96 shadow-xl">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions  justify-start mt-40">
                                    <button className="btn opacity-55">Peritoneal dialysis</button>
                                </div>
                            </div>
                        </div>
                    </div>
