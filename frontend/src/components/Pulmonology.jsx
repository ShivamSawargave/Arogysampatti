            ...
            <div className='md:pt-28 pt-16'>
                <div className="carousel w-full">
                    ...
                    <div id="item4" className="carousel-item w-full ">
                        <img
                            src="https://t3.ftcdn.net/jpg/08/23/76/74/360_F_823767431_Bos56gPBVam0WQKO5ph5OKKUyvBiY9b1.jpg"
                            className="w-full h-72" />
                    </div>
                </div>
                <div className='md:text-5xl text-3xl font-semibold flex justify-center items-center p-8'>About Pulmonology</div>

                <div>
                    <div className='md:p-8 p-4'>The Pulmonology Department renders bronchoscopy services, both flexible and rigid. The department is well known for its competent work in interventional bronchoscopy, especially Trans-Bronchial Needle Aspiration (TBNA)/ biopsies, endobronchial electrosurgery procedures, balloon bronchoplasty and stenting. Pleuroscopy and video assisted thoracoscopic procedures add to another field of the proficiency of the department. The Pulmonology Department is also equipped with the Endobronchial Ultrasound (EBUS) facility. The department utilizes all the latest and modern tools for broncoscopic diagnosis.</div>
                    <div className='md:p-8 p-4'>The department also consists of a specialized sleep laboratory and conducts multiple sleep studies in the laboratory for patients with diseases and conditions related to obesity hypoventilation syndrome, obstructive sleep apnoea, day time sleepiness and snoring disorders and multiple others.</div>
                    <div className='md:p-8 p-4'>The expert team of pulmonologists is highly specialized in complex surgical and medical procedures and is experienced in treating the patients of all ages with utmost care and as per the complete satisfaction of the indivisdual. The pulmonologists at Fortis work in collaboration with the experts of almost all other specialities in order to deliver personalised and effective care to the patient.</div>
                </div>
            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>PRINCIPAL DIRECTOR & UNIT HEAD- PULMONOLOGY & SLEEP MEDICINE</p>
                                    <div className="card-actions justify-between">
                                    <a href="ApekshaPatilPulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>SENIOR DIRECTOR & UNIT HEAD- PULMONOLOGY & SLEEP MEDICINE</p>
                                    <div className="card-actions justify-between">
                                    <a href="ManmathShelkePulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl cover h-96">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>SENIOR DIRECTOR & HOD PULMONOLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href="TirupattiShelkePulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 bg-cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR PULMONOLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href="RajeshSwamiPulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR PULMONOLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href="AnupKulkarniPulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR PULMONOLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href="ArjunShelkePulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR & UNIT HEAD PULMONOLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href="SharadSonawanePulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>DIRECTOR PULMONOLOGY</p>
                                    <div className="card-actions justify-between">
                                    <a href="SonalBarolePulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>SENIOR DIRECTOR & HEAD- PULMONOLOGY, PULMONOLOGY CRITICAL CARE & SLEEP MEDICINE</p>
                                    <div className="card-actions justify-between">
                                    <a href="TusharGangawanePulmonology"><div className="border-2 border-slate-300 hover:bg-green-300 p-2">View Full Profile</div></a>
                                        <div className="border-2 border-slate-300 bg-green-300 hover:bg-white p-2">Book An Appointment</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card bg-base-100 image-full w-96 shadow-xl h-72">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-start mt-40">
                                    <button className="btn opacity-55">Peak flow meter</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div className="card bg-base-100 image-full w-96 shadow-xl">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-start mt-40">
                                    <button className="btn opacity-55">spirometry</button>
                                </div>
                            </div>
                        </div>
                    </div>
