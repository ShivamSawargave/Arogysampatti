    ...
    <>
         <NavContact />
            ...
            <div className='md:pt-28 pt-16'>
                ...
                <div className='md:text-5xl text-3xl font-semibold flex justify-center items-center p-8'>About Oral & Maxillofacial Surgery</div>

                <div>
                    <div className='md:p-8 p-4' t>Oral and Maxillofacial Surgery is a dedicated department engaged in managing and treating defects and injuries of the face, jaws, head and neck along with the hard and the soft tissues of the oral and maxillofacial region. At Fortis, the team experts help diagnose, treat and cure a broad range of conditions that may arise in the oral and maxillofacial region. Our team of experts is highly experienced in handling any road traffic accident cases involving maxillofacial surgeries. The team also helps in educating patients about the benefits of oral hygiene. The surgeons are skilled in treating various complex cases during the childbirth like cleft lip and palate, and traumatic injuries such as fractured jaws and facial skeleton. They are also specialized in treating and fixing problems related to the mouth cavity, teeth and face. The team of oral surgeons has its expertise in treating oral cancers, reconstructive surgery and oral medicine. The Fortis hospital provides excellent and superior quality care to its patients.
                    </div >
                </div >
            </div >
