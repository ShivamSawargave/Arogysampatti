    ...
    return (
        <>
            ...
            <div className='md:pt-28 pt-16'>
                ...
                <div className='md:text-5xl text-3xl font-semibold flex justify-center items-center p-8'>About Head & Neck Oncosurgery</div>
                        ...
                        <div>
                            <div className="card bg-base-100 w-96 shadow-xl h-96 cover">
                                ...
                                <div className="card-body">
                                    ...
                                    <p>PRINCIPAL DIRECTOR GINAE ONCOLOGY</p>
                                    <div className="card-actions justify-between">
